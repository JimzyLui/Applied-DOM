(function(window) {
  ...
  const setMyLightClass = function(event, desiredClass) {
    ...
    if (event == null) {
      ...
      lightId = event.target.dataset.lightId;
    }
  ...
  btn4.addEventListener("click", function(event) {
    setMyLightGreen.apply(event.target, [event, "light-green"]);
  });
  ...
  btn10.addEventListener("click", function() {
    setLight10Green();
    // setMyLightGreen.bind(btn10)();  // this also works
    // setMyLightClass.bind(btn10)(event, "light-green"); // this works as well
    // setMyLightClass.bind(btn10)(null, "light-green"); // this works as well
  });
